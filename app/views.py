...
from app.forms import (AuthenticationForm,CreateStatementForm,RegisterForm,StatementStatusForm,)
...
@login_required
def addstatement(request: HttpRequest):
    if request.method == "POST":
    ...
    return render(request, "addstatement.html", {"form": form})
